# SpringBoot中通过@Valid和@Validated两个注解实现@GetMapping或@PostMapping中的参数校验
注意点：
1. 单独的参数需要再类上使用@Validated注解，否则会失效。
2. 实体类中的参数校验需要使用@Valid注解在指定的类上。
...
- 参考链接：https://www.jianshu.com/p/89a675b7c900


# SpringBoot中的统一处理操作@RestControllerAdvice和@ExceptionHandler注解搭配实现
...
github地址： https://github.com/jmnarloch/modelmapper-spring-boot-starter
